    ...
    <div className="min-h-screen bg-muted/30">
      ...
      <div className="space-y-12">
        ...
        <div className="relative">
          <section className="p-8 min-h-screen flex flex-col justify-center print:page-break-after border-4 border-blue-500 bg-blue-50">
        ...
        <div className="relative">
          <section className="p-8 min-h-screen flex flex-col justify-center print:page-break-after print:page-break-before border-4 border-blue-500 bg-blue-50">
        ...
        <div className="relative">
          <section className="p-8 min-h-screen flex flex-col print:page-break-after print:page-break-before border-4 border-blue-500 bg-blue-50">
            ...
            <table className="w-full border-collapse text-sm mb-6">
              ...
              <tbody>
                ...
                <tr className="bg-blue-200 font-semibold">
                  <td className="border border-foreground p-3 font-bold">Average</td>
                  <td className="border border-foreground p-3 text-center text-lg font-bold">
                ...
                <tr className="bg-blue-200 font-semibold">
                  <td className="border border-foreground p-3 font-bold">Rank</td>
                  <td className="border border-foreground p-3 text-center text-lg font-bold">
                    {overallRank}
                  </td>
                  <td className="border border-foreground p-3 text-center text-lg font-bold">
        ...
        <div className="relative">
          <section className="p-8 min-h-screen flex flex-col print:page-break-before border-4 border-blue-500 bg-blue-50">
